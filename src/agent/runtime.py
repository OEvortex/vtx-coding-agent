...
from agent.agents import AgentRegistry, LoadedAgent
from agent.agents.activate import _filter as _agent_tool_filter
from agent.agents.activate import compose_active_commands
...
class ConversationRuntime:
    ...
    def ensure_background_manager(self) -> Any:
        ...
        if self._background_manager is None:
            from agent.tools.background import BackgroundTaskManager, set_manager
    ...
    async def close(self) -> None:
        ...
        if self._background_manager_token is not None:
            from agent.tools.background import reset_manager
    ...
    def active_commands(self) -> dict:
        ...
        """
        from agent.extensions import ExtensionCommand
