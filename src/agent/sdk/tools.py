...
from agent.sdk.approvals import ToolApprovalItem
from agent.sdk.guardrails.types import ToolGuardrailSpec, normalize_tool_guardrail_specs
...
class _AgentAsTool(BaseTool):
    ...
    async def execute(
        ...
        from agent.sdk.runner import Runner
