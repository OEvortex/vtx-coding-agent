...
from agent.sdk.agent import Agent
from agent.sdk.approvals import RunState, ToolApprovalItem
from agent.sdk.guardrails import run_input_guardrails, run_output_guardrails
from agent.sdk.items import (
    HandoffCallItem,
    HandoffOutputItem,
    MessageOutputItem,
    RunItem,
...
from agent.sdk.results import RunResult
from agent.sdk.run_config import RunConfig
from agent.sdk.sessions import InMemorySession, Session
...
from telemetry.tracing import Trace, current_trace, is_tracing_disabled, span
...
class Runner:
    ...
    async def _run_impl(
        ...
        from agent.sdk.guardrails.types import _InputGuardrailData
        ...
        if current_active_agent.output_guardrails:
            from agent.sdk.guardrails.types import _OutputGuardrailData
    ...
    async def _run_single_turn_sdk(
        *,
        ...
        from protocol import ThinkingDeltaEvent
        ...
        # Build SDK items.
        if thinking_chunks:
            from agent.sdk.items import ReasoningItem
    ...
    async def _maybe_handoff(
        ...
        from protocol.types import UserMessage
