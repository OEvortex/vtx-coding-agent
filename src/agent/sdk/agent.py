...
from agent.sdk.guardrails import InputGuardrail, OutputGuardrail
from agent.sdk.handoffs import Handoff
from agent.sdk.tools import FunctionTool
...
class Agent[TContext]:
    ...
    def as_tool(
        ...
        """
        from agent.sdk.tools import _AgentAsTool
