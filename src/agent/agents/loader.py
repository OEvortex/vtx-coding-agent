...
from agent.agents.api import AgentAPI, LoadedAgent
from agent.agents.schema import AgentDef
from agent.extensions import AGENT_CHANGED
...
def _wrap_callable_as_tool(fn: Callable[..., Any], fallback_name: str) -> BaseTool:
    ...
    from agent.sdk.tools import tool as sdk_tool
    from agent.tools.base import BaseTool
