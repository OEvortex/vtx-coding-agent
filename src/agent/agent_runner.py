...
from agent.hooks.agent_hook import AgentHook
from agent.tools import BaseTool
from ai import BaseProvider
from protocol.events import Event, StreamEvent
from protocol.types import AssistantMessage, Message, StopReason, ToolResultMessage
...
def _build_composite(hooks: list[AgentHook] | None) -> AgentHook | None:
    ...
    from agent.hooks.agent_hook import CompositeHook
