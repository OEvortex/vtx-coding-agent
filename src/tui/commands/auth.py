...
from ai import is_copilot_logged_in as has_saved_copilot_credentials
from ai import is_openai_logged_in as has_saved_openai_credentials
...
class AuthCommands(CommandSupport):
    ...
    async def _refresh_after_api_key(self, provider_id: str) -> None:
        ...
        from ai import DYNAMIC_PROVIDERS, refresh_provider
