...
- When waiting on a background sub-agent to proceed, pause work: give the user a brief status message and stop calling tools until the response arrives."""  # fmt: skip
