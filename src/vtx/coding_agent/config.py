...
def get_agents_dir() -> Path:
    from vtx.core.paths import get_agents_dir as _get_agents_dir
...
def set_model_provider_filter(provider: str) -> Config:
    ...
    """
    from vtx.ai.provider_catalog import _load as _load_providers
...
# imports (`from vtx.coding_agent.config import config`) resolve identically
