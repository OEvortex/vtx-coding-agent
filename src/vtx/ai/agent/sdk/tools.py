...
from vtx.ai.agent.sdk.approvals import ToolApprovalItem
from vtx.ai.agent.sdk.guardrails.types import ToolGuardrailSpec, normalize_tool_guardrail_specs
...
def _function_to_params_model(func: Callable[..., Any]) -> tuple[type[BaseModel], dict[str, Any]]:
    ...
    module = getattr(func, "__module__", "agent.sdk")
...
class _AgentAsTool(BaseTool):
    ...
    async def execute(
        ...
        from vtx.ai.agent.sdk.runner import Runner
