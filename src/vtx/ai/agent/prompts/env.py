...
Provides a small ``# Env`` block with the live execution context the model
should know about, including the working directory, project root, OS, Python
...
from vtx.ai.agent.version import VERSION as VTX_VERSION
