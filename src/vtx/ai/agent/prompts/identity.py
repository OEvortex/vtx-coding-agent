...
- Use standard ASCII punctuation and standard hyphens; no emojis, em dashes, or citation markers."""  # noqa: E501
...
- Run commands for real; never fabricate output."""  # noqa: E501
...
- Analyze tool errors before retrying; switch strategy or ask after 3 fails. Leave unrelated failures alone."""  # noqa: E501
...
- Skills: user in ~/.agents/skills, project in .agents/skills."""  # noqa: E501
