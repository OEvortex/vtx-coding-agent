...
_THEMES: dict[str, ThemeConfig] = {
    "titanium": ThemeConfig(
        id="titanium",
        label="Titanium (Pi-Style)",
        colors=ColorsConfig(
            bg="#0f1216",
            fg="#e8ecf4",
            dim="#6b7280",
            ...
            accent="#00b4ff",
            info="#00b4ff",
            markdown_heading="#00b4ff",
            markdown_code="#00ff88",
            selected="#0082b3",
            error="#ff4757",
            notice="#ffb347",
            diff_added="#00ff88",
    ...
    "titanium-light": ThemeConfig(
        ...
        colors=ColorsConfig(
            ...
            accent="#0077b6",
            info="#0077b6",
            markdown_heading="#0077b6",
            markdown_code="#00875a",
            selected="#0077b6",
            error="#de350b",
            notice="#ff8b00",
            diff_added="#00875a",
...
_SYNTAX_COLORS: dict[str, SyntaxColorConfig] = {
    ...
    "titanium-light": SyntaxColorConfig(
        command="#00875a",
        arg="#151820",
        option="#0077b6",
        operator="#0077b6",
