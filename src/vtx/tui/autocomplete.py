...
class PullRequestProvider(AutocompleteProvider):
    ...
    def should_trigger(self, text: str, cursor_col: int) -> bool:
        return is_available() and self._extract_token(text, cursor_col) is not None
...
DEFAULT_COMMANDS = [
    ...
    SlashCommand("goal", "start a guided goal (persistent objective)"),
    SlashCommand("goal-direct", "create a goal immediately from a complete objective"),
    SlashCommand("sisyphus", "start a guided ordered (step-by-step) goal"),
    SlashCommand("sisyphus-direct", "create an ordered goal immediately"),
    SlashCommand("goal-list", "list open goals"),
    SlashCommand("goal-status", "show the focused goal dashboard (verbose | health)"),
    SlashCommand("goal-focus", "choose the open goal this session focuses on"),
    SlashCommand("goal-unfocus", "clear this session's goal focus"),
    SlashCommand("goal-tweak", "revise the focused objective and plan"),
    SlashCommand("goal-pause", "pause the focused goal"),
    SlashCommand("goal-resume", "resume a paused or blocked goal"),
    SlashCommand("goal-clear", "archive the focused goal"),
    SlashCommand("goal-cancel", "cancel an unconfirmed goal draft"),
    SlashCommand("goal-settings", "toggle goal behaviour settings"),
]
