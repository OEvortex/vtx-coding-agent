...
class GatewayServiceInstaller:
    ...
    def _install_systemd(
        ...
        content = _systemd_unit_content(
            description=f"AgeniteClaw Gateway ({options.name})",
            command=command,
    ...
    def _install_launchd(
        ...
        stdout_path = self.home / ".agenite" / "mini" / "logs" / f"{log_stem}.launchd.log"
        stderr_path = self.home / ".agenite" / "mini" / "logs" / f"{log_stem}.launchd.err.log"
        payload = {
            "Label": label,
