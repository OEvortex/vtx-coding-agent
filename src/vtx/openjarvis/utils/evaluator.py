...
if TYPE_CHECKING:
    from vtx.openjarvis.providers.base import LLMProvider
...
_EVALUATE_TOOL = [
    {
        ...
        "function": {
            ...
            "description": "Decide whether the user should be notified about this background task result.",  # noqa: E501
            "parameters": {
                "type": "object",
                "properties": {
                    "should_notify": {
                        "type": "boolean",
                        "description": "true = result contains actionable/important info the user should see; false = routine or empty, safe to suppress",  # noqa: E501
                    },
                    "reason": {
                        "type": "string",
...
async def evaluate_response(
    ...
    """
    try:
        from vtx.openjarvis.utils.helpers import collect_stream_to_response
