...
class BaseChannel(ABC):
    ...
    def is_allowed(self, sender_id: str) -> bool:
        ...
        if str(sender_id) in allow_list:
            return True
        return bool(is_approved(self.name, str(sender_id)))
    ...
    async def _handle_message(
        ...
        """Handle an incoming message: check permissions, issue pairing codes in DMs, or forward to bus."""  # noqa: E501
