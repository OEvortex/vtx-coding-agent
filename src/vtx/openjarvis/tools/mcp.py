        ...
        try:
            ...
            if enabled_tools and not allow_all_tools:
                ...
                if unmatched_enabled_tools:
                    logger.warning(
                        "MCP server '{}': enabledTools entries not found: {}. Available raw names: {}. "  # noqa: E501
            ...
            if any(
                ...
                hint = (
                    " Hint: this looks like stdio protocol pollution. Make sure the MCP server writes "  # noqa: E501
