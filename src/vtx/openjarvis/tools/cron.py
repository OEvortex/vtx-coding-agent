...
_CRON_PARAMETERS = tool_parameters_schema(
    ...
    job_id=StringSchema("Required for remove: job id to delete (from action='list')."),
    required=["action"],
    description=(
...
class CronTool(Tool, ContextAware):
    ...
    def __init__(self, cron_service: CronService, default_timezone: str = "UTC"):
        ...
        self._origin_metadata: ContextVar[dict[str, Any] | None] = ContextVar(
            "cron_origin_metadata", default=None
        )
    ...
    def _add_job(
        ...
        if tz and (err := self._validate_timezone(tz)):
            return err
        ...
        if every_seconds:
            ...
            try:
                ...
                return f"Error: invalid ISO datetime format '{at}'. Expected format: YYYY-MM-DDTHH:MM:SS"  # noqa: E501
