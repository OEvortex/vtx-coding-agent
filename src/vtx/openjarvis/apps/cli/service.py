...
AGENITE_CLAW_EXTENSION_REGISTRY_URL = (
    "https://raw.githubusercontent.com/Re-bin/openjarvis-extension/main/registry.json"
)
AGENITE_CLAW_EXTENSION_RAW_BASE = (
    "https://raw.githubusercontent.com/Re-bin/openjarvis-extension/main"
)
_CATALOG_SOURCES = (
...
class CliAppManager:
        ...
        remove = compact_dict(
            {
                ...
                "verification": (
                    ...
                    else ["vtx.openjarvis_state_absent", "managed_paths_absent"]
                ),
            }
        )
        return app_manifest(
    ...
    def _fallback_skill(self, app: dict[str, Any]) -> str:
        ...
        description = _catalog_description(app) or f"Use {display} from vtx.openjarvis."
        return f"""---
...
Use this skill when the user asks openjarvis to operate {display} through its installed CLI app.
...
"""
    ...
    def _with_openjarvis_skill_note(self, content: str, app: dict[str, Any]) -> str:
        marker = "<!-- openjarvis-cli-app-note -->"
...
"""
    ...
    def install_skill(self, app: dict[str, Any]) -> Path:
        ...
        content = self._with_openjarvis_skill_note(content, app)
    ...
    def uninstall(self, name: str) -> dict[str, Any]:
        ...
        if strategy != "bundled":
            ...
            if still_managed or (not managed_entry_path and still_available):
                ...
                message = (
                    ...
                    "so openjarvis kept it installed."
                )
                return self.payload() | {
                    "last_action": {
                        "ok": False,
        ...
        if strategy == "bundled" and still_available:
            message = (
                f"Removed {app['display_name']} from vtx.openjarvis. {entry_point} "
                "is still available because it is managed outside openjarvis."
            )
