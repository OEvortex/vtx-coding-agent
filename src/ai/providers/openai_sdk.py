...
from ai.base import ENV_API_KEY_MAP, BaseProvider, LLMStream, ProviderConfig, resolve_api_key
from ai.providers.sanitize import sanitize_surrogates
...
class OpenAISDKProvider(BaseProvider):
    ...
    def _resolve_dynamic_key_for(config: ProviderConfig) -> str | None:
        from ai.oauth.dynamic import get_dynamic_api_key
    ...
    def _convert_assistant_message(self, msg: AssistantMessage) -> SDKMessage:
        ...
        from ai.phase_parser import INLINE_THINK_SIGNATURE
    ...
    def should_retry_for_error(self, error: Exception) -> bool:
        from ai.rate_limit import is_rate_limit_error
