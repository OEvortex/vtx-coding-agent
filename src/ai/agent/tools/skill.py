...
class SkillTool(BaseTool):
    ...
    async def execute(
        ...
        def find_skill_dir(name: str) -> tuple[Path | None, bool]:
            # 1. Project skills
            from ai.agent.context.skills import _project_skill_dirs
            ...
            from coding_agent import get_config_dir as get_vtx_config_dir
            ...
            try:
                builtin_resource = resources.files("coding_agent").joinpath("builtin_skills")
