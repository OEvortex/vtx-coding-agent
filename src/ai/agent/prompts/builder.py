...
from ai.agent.context import Context, formatted_agent_mds, formatted_git_context, formatted_skills
from ai.agent.prompts.env import build_env_section
from ai.agent.prompts.identity import DEFAULT_VTX_BASE
from ai.agent.prompts.tooling import build_tool_guidelines_section
