...
from ai.agent.agent_runner import AgentRunSpec, run_agent_turn
from ai.agent.context import Context
from ai.agent.extensions import (
    AGENT_END,
    AGENT_START,
    COMPACTION_END,
    COMPACTION_START,
...
from ai.agent.session import CompactionEntry, MessageEntry, Session
...
class Agent:
    ...
    def _drain_background_notifications(self) -> list[Event]:
        ...
        """
        from ai.agent.tools.background import BACKGROUND_NOTIFICATION_TAG
