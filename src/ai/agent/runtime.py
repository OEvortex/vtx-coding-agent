...
from ai.agent.agents import AgentRegistry, LoadedAgent
from ai.agent.agents.activate import _filter as _agent_tool_filter
from ai.agent.agents.activate import compose_active_commands
from ai.agent.context import Context
from ai.agent.extensions import EventBus, LoadedExtensions
...
from ai.agent.tools import DEFAULT_TOOLS, BaseTool, tools_by_name
...
class ConversationRuntime:
    ...
    def ensure_background_manager(self) -> Any:
        ...
        if self._background_manager is None:
            from ai.agent.tools.background import BackgroundTaskManager, set_manager
    ...
    def active_commands(self) -> dict:
        ...
        """
        from ai.agent.extensions import ExtensionCommand
