...
from ai.agent.sdk.approvals import ToolApprovalItem
from ai.agent.sdk.guardrails.types import ToolGuardrailSpec, normalize_tool_guardrail_specs
...
class _AgentAsTool(BaseTool):
    ...
    async def execute(
        ...
        from ai.agent.sdk.runner import Runner
