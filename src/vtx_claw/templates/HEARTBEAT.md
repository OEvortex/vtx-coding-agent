...
<!--
This file is checked periodically by your vtx-claw agent. When vtx-claw gateway starts with gateway.heartbeat.enabled=true, it automatically registers a protected heartbeat cron job that reads this file.
