...
This directory contains built-in skills that extend vtx-claw's capabilities.
...
When skills reference large local documentation or logs, prefer vtx-claw's built-in
