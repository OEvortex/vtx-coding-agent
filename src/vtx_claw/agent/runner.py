...
from vtx_claw.agent.context_governance import ContextGovernanceConfig, ContextGovernor
from vtx_claw.agent.hook import AgentHook, AgentHookContext, AgentRunHookContext
...
from vtx_claw.utils.file_edit_events import prepare_file_edit_tracker as _prepare_file_edit_tracker
    ...
    async def _request_model(
        ...
        *,
        ...
        if timeout_s is None:
            ...
            # Set VTX_CLAW_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("VTX_CLAW_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        from vtx_claw._vtx_bridge import create_bridge_stream
        ...
        # (VTX_CLAW_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded VTX_CLAW_LLM_TIMEOUT_S.
