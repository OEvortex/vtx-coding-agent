...
from vtx_claw.agent import context as agent_context
from vtx_claw.agent import model_presets as preset_helpers
from vtx_claw.agent.autocompact import AutoCompact
from vtx_claw.agent.context import ContextBuilder
from vtx_claw.agent.cron_turns import CronTurnCoordinator
from vtx_claw.agent.hook import AgentHook, CompositeHook
from vtx_claw.agent.memory import Consolidator
from vtx_claw.agent.progress_hook import AgentProgressHook
from vtx_claw.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from vtx_claw.agent.subagent import SubagentManager
from vtx_claw.agent.tools.context import (
    RequestContext,
    bind_request_context,
    reset_request_context,
)
from vtx_claw.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
...
from vtx_claw.bus.progress import build_bus_progress_callback
...
from vtx_claw.command import CommandContext, CommandRouter, register_builtin_commands
from vtx_claw.config.schema import AgentDefaults, ModelPresetConfig
from vtx_claw.cron.session_turns import cron_history_overrides
...
from vtx_claw.session import turn_continuation
from vtx_claw.session.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from vtx_claw.session.keys import UNIFIED_SESSION_KEY, session_key_for_channel
from vtx_claw.session.manager import Session, SessionManager, replay_max_messages_for_context
...
if TYPE_CHECKING:
    from vtx_claw.config.schema import ChannelsConfig, ProviderConfig, ToolsConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        # VTX_CLAW_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("VTX_CLAW_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    def _set_tool_context(
        ...
        from vtx_claw.agent.tools.context import ContextAware
        ...
        try:
            result = await self.runner.run(
                AgentRunSpec(
                    ...
                    # Sustained goals may legitimately exceed VTX_CLAW_LLM_TIMEOUT_S; idle stall
                    # is still capped by VTX_CLAW_STREAM_IDLE_TIMEOUT_S in streaming providers.
