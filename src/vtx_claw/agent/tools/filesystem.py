...
from vtx_claw.agent.tools.file_state import FileStates, _hash_file, current_file_states
...
from vtx_claw.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from vtx_claw.utils.document import extract_text
