"""JSON Schema fragment types: all subclass :class:`~vtx_claw.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~vtx_claw.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~vtx_claw.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~vtx_claw.agent.tools.base.Schema`.
...
from vtx_claw.agent.tools.base import Schema
...
class BooleanSchema(Schema):
    ...
    def __init__(
        self, *, description: str = "", default: bool | None = None, nullable: bool = False
    ) -> None:
        self._description = description
...
class ArraySchema(Schema):
    ...
    def to_json_schema(self) -> dict[str, Any]:
        ...
        if self._nullable:
            t = ["array", "null"]
        d: dict[str, Any] = {"type": t, "items": Schema.fragment(self._items_schema)}
        if self._description:
            d["description"] = self._description
