...
from vtx_claw.agent.tools.schema import NumberSchema, StringSchema, tool_parameters_schema
from vtx_claw.security.workspace_access import current_workspace_scope
...
class SpawnTool(Tool, ContextAware):
    ...
    async def execute(
        self, task: str, label: str | None = None, temperature: float | None = None, **kwargs: Any
    ) -> str:
