...
class SkillsLoader:
    ...
    def _parse_vtx_claw_metadata(self, raw: object) -> dict:
        """Extract vtx_claw/openclaw metadata from a frontmatter field.
        ...
        if not isinstance(data, dict):
            return {}
        payload = data.get("vtx_claw", data.get("openclaw", {}))
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get vtx_claw metadata for a skill (cached in frontmatter)."""
        raw_meta = self.get_skill_metadata(name) or {}
        return self._parse_vtx_claw_metadata(raw_meta.get("metadata"))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        return [
            ...
            and (
                self._parse_vtx_claw_metadata(meta.get("metadata")).get("always")
                or meta.get("always")
            )
        ]
