...
def get_config_path() -> Path:
    ...
    Delegates to ``vtx_claw.config.loader.get_config_path`` at call time so
    that importing this module never triggers a circular import during startup.
    """
    from vtx_claw.config.loader import get_config_path as _loader_get_config_path
...
def is_default_workspace(workspace: str | Path | None) -> bool:
    """Return whether a workspace resolves to vtx_claw's default workspace path."""
    current = (
