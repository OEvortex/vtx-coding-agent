...
from vtx_claw.config.paths import get_runtime_subdir
from vtx_claw.security.workspace_policy import is_path_within
...
VTX_CLAW_EXTENSION_REGISTRY_URL = (
    "https://raw.githubusercontent.com/Re-bin/vtx_claw-extension/main/registry.json"
)
VTX_CLAW_EXTENSION_RAW_BASE = "https://raw.githubusercontent.com/Re-bin/vtx_claw-extension/main"
_CATALOG_SOURCES = (
    ...
    ("extensions", VTX_CLAW_EXTENSION_REGISTRY_URL, VTX_CLAW_EXTENSION_RAW_BASE, False),
)
...
class CliAppManager:
        ...
        remove = compact_dict(
            {
                ...
                "verification": (
                    ...
                    else ["vtx_claw_state_absent", "managed_paths_absent"]
                ),
            }
        )
        return app_manifest(
    ...
    def _fallback_skill(self, app: dict[str, Any]) -> str:
        ...
        description = _catalog_description(app) or f"Use {display} from vtx_claw."
        return f"""---
...
Use this skill when the user asks vtx_claw to operate {display} through its installed CLI app.
...
"""
    ...
    def _with_vtx_claw_skill_note(self, content: str, app: dict[str, Any]) -> str:
        marker = "<!-- vtx_claw-cli-app-note -->"
...
"""
    ...
    def install_skill(self, app: dict[str, Any]) -> Path:
        ...
        content = self._with_vtx_claw_skill_note(content, app)
    ...
    def uninstall(self, name: str) -> dict[str, Any]:
        ...
        if strategy == "bundled" and still_available:
            message = (
                f"Removed {app['display_name']} from vtx_claw. {entry_point} "
                "is still available because it is managed outside vtx_claw."
            )
