...
RESTART_NOTIFY_CHANNEL_ENV = "VTX_CLAW_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "VTX_CLAW_RESTART_NOTIFY_CHAT_ID"
RESTART_NOTIFY_METADATA_ENV = "VTX_CLAW_RESTART_NOTIFY_METADATA"
RESTART_STARTED_AT_ENV = "VTX_CLAW_RESTART_STARTED_AT"
