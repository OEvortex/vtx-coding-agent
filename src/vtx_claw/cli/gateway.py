...
from vtx_claw.gateway import (
    GatewayRuntime,
    GatewayRuntimePaths,
    GatewayStartOptions,
    GatewayStatus,
)
from vtx_claw.gateway.service import (
...
def create_gateway_app(
    *,
    ...
    gateway_app = typer.Typer(
        help="Start and manage the vtx-claw gateway.",
    ...
    def gateway_install_service(
        ...
        verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output"),
        config: str | None = typer.Option(None, "--config", "-c", help="Path to config file"),
        name: str = typer.Option("vtx_claw-gateway", "--name", help="Service name"),
