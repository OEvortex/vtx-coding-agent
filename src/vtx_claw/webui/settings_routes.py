...
from vtx_claw.agent.tools.mcp import request_mcp_reload
from vtx_claw.bus.queue import MessageBus
from vtx_claw.webui.cli_apps_api import cli_apps_action, cli_apps_payload
from vtx_claw.webui.http_utils import query_first as _query_first
from vtx_claw.webui.mcp_presets_api import mcp_presets_settings_action
...
from vtx_claw.webui.version_check import check_for_update

QueryParams = dict[str, list[str]]

_MCP_VALUES_HEADER = "X-VtxClaw-MCP-Values"
...
class WebUISettingsRouter:
    ...
    async def _handle_settings_version_check(self, request: WsRequest) -> Response:
        ...
        return self._json_response({"updateAvailable": update_info})
