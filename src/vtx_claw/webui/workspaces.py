...
def default_scope_for_webui(
    default_workspace: Path, default_restrict_to_workspace: bool
) -> WorkspaceScope:
...
class WebUIWorkspaceController:
    ...
    def scope_from_envelope(
        self, envelope: dict[str, Any], *, session_key: str | None, controls_available: bool
    ) -> WorkspaceScope:
    ...
    def scope_for_new_chat(
        self, envelope: dict[str, Any], *, controls_available: bool
    ) -> WorkspaceScope:
        return self.scope_from_envelope(
            envelope, session_key=None, controls_available=controls_available
        )
    ...
    def scope_for_set_request(
        ...
        *,
        ...
        return self.scope_from_envelope(
            envelope, session_key=f"websocket:{chat_id}", controls_available=controls_available
        )
