...
def sign_media_path(
    abs_path: Path, *, secret: bytes, media_dir: MediaDirProvider = _default_media_dir
) -> str | None:
...
def signed_media_attachments(
    paths: list[str], *, sign_path: SignedMediaPath
) -> list[dict[str, Any]]:
...
def attach_signed_media_urls(payload: dict[str, Any], *, sign_path: SignedMediaUrl) -> None:
