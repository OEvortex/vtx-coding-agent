...
Persistent storage at ``~/.vtx_claw/pairing.json`` keeps approved senders
...
from vtx_claw.utils.helpers import _write_text_atomic
...
def generate_code(channel: str, sender_id: str, ttl: int = _TTL_DEFAULT_S) -> str:
