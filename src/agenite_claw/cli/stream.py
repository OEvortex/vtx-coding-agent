...
class ThinkingSpinner:
    ...
    def __init__(self, console: Console | None = None, bot_name: str = "agenite_claw"):
...
class StreamRenderer:
    ...
    async def on_delta(self, delta: str) -> None:
        ...
        if self._live is None:
            ...
            self.ensure_header()
            self._live = Live(
                self._renderable(), console=self._console, auto_refresh=False, transient=True
            )
            self._live.start()
        else:
