...
from agenite_claw.agent.hook import AgentHook, AgentHookContext
from agenite_claw.agent.runner import AgentRunner, AgentRunSpec
...
from agenite_claw.config.schema import AgentDefaults, ToolsConfig
...
class SubagentManager:
    ...
    def _build_tools(
        self, workspace: Path | None = None, tools_config: ToolsConfig | None = None
    ) -> ToolRegistry:
    ...
    def _build_subagent_prompt(self, workspace: Path | None = None) -> str:
        ...
        skills_summary = SkillsLoader(
            root, disabled_skills=self.disabled_skills
