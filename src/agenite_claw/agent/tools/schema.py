"""JSON Schema fragment types: all subclass :class:`~agenite_claw.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~agenite_claw.agent.tools.base.Schema.validate_json_schema_value` /
...
Shared validation and fragment normalization are on the class methods of :class:`~agenite_claw.agent.tools.base.Schema`.
