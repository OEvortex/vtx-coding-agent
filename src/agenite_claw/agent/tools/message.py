...
@tool_parameters(
    tool_parameters_schema(
        content=StringSchema("Content to send proactively/cross-channel (not a normal reply)."),
        channel=StringSchema("Optional target channel for proactive/cross-channel delivery."),
