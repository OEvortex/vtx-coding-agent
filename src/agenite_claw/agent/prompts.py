"""Compact default system prompt for agenite-claw.
...
AGENITE_CLAW_IDENTITY = (
    "You are agenite-claw, a personal coding/assistant agent. Read, search, edit code, "
...
AGENITE_CLAW_GENERAL_RULES = """# General
