...
This module owns agenite_claw's transcription behavior: config resolution,
...
HTTP details; those live in ``agenite_claw.providers.transcription``.
"""
...
from agenite_claw.audio.transcription_registry import (
...
async def transcribe_audio_data_url(
    data_url: Any, config: EffectiveTranscriptionConfig, *, duration_ms: Any = None
) -> str:
...
async def transcribe_audio_file(
    file_path: str | Path, config: EffectiveTranscriptionConfig
) -> str:
