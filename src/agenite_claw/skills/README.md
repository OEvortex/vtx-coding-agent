...
This directory contains built-in skills that extend agenite-claw's capabilities.
...
When skills reference large local documentation or logs, prefer agenite-claw's built-in
