...
from agenite_claw.config.paths import get_legacy_sessions_dir
...
from agenite_claw.utils.subagent_channel_display import scrub_subagent_announce_body
    ...
    def get_history(
        ...
        *,
        ...
        start_idx = recent_message_start_index(
            unconsolidated, max_messages, extend_to_user=extend_to_user
        )
