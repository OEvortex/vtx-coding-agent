...
def runner_wall_llm_timeout_s(
    ...
    *,
    ...
    """Wall-clock cap for :class:`~agenite_claw.agent.runner.AgentRunner` when streaming an LLM.
    ...
    ``metadata`` when the caller already holds :attr:`~agenite_claw.session.manager.Session.metadata`
    for this turn.
    """
