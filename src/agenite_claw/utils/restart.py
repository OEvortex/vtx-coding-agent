...
RESTART_NOTIFY_CHANNEL_ENV = "AGENITE_CLAW_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "AGENITE_CLAW_RESTART_NOTIFY_CHAT_ID"
RESTART_NOTIFY_METADATA_ENV = "AGENITE_CLAW_RESTART_NOTIFY_METADATA"
RESTART_STARTED_AT_ENV = "AGENITE_CLAW_RESTART_STARTED_AT"
...
def consume_restart_notice_from_env() -> RestartNotice | None:
    ...
    return RestartNotice(
        channel=channel, chat_id=chat_id, started_at_raw=started_at_raw, metadata=metadata
    )
