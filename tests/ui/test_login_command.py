...
from vtx.llm.oauth.openai import OpenAICredentials
from vtx.ui.commands import CommandsMixin
from vtx.ui.commands import auth as commands
...
def test_login_picker_includes_yaml_providers(monkeypatch):
    ...
    from vtx.llm.oauth.dynamic import DynamicProviderStatus
    from vtx.llm.provider_catalog import ProviderInfo
