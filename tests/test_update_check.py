...
from vtx.core.update_check import get_newer_pypi_version, is_newer_version
...
async def test_get_newer_pypi_version_returns_newer_value(monkeypatch) -> None:
    ...
    monkeypatch.setattr("vtx.core.update_check.fetch_latest_pypi_version", fake_fetch)
