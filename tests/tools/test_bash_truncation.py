...
from agent.tools.bash import MAX_OUTPUT_BYTES, MAX_OUTPUT_LINES, BashParams, BashTool
...
async def test_default_truncates_with_temp_file_path(monkeypatch):
    ...
    monkeypatch.setattr("agent.tools.bash._write_full_output_to_temp", lambda _: fake_path)
