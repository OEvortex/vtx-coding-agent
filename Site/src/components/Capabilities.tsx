...
const capabilities = [
  ...
  },
  {
    ...
    icon: Wrench,
    body: "read (with image viewing), edit, write, bash, find, skill, web, ask_user, and task. Each Pydantic-typed and cancellable.",
    span: "lg:col-span-5",
    accent: false,
  },
  {
  ...
  {
    n: "05",
    title: "Extensions & YAML hooks",
    icon: GitBranch,
    body: "Drop a Python module into your workspace to register tools and slash commands, or wire lifecycle automation with declarative .vtx/hooks.yml.",
    span: "lg:col-span-4",
    accent: false,
  },
  {
